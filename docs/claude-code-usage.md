...
Claude Code 是原 Superpowers 的主要目标环境之一，技能中出现的 Claude 工具名可以直接按 Claude Code 能力执行。只有在技能文本明确提到 Codex、Copilot 或 Gemini 专用工具时，才需要转换到 Claude Code 等价能力。
