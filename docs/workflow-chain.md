...
| 阶段 | 名称 | 主要技能 | 产物或结果 |
| --- | --- | --- | --- |
| 0 | 平台加载 | `.codex-plugin/plugin.json`, `.claude-plugin/plugin.json` | Codex / Claude Code 识别插件和 skills |
...
1. 将 `spec-driven-development/scripts/validate_spec.py` 和 `test-driven-development/scripts/validate_tdd_evidence.py` 接入 CI 或插件发布前检查。
