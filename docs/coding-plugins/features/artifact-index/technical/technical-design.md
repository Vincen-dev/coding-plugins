...
| REQ-003 | preflight 必须校验所有真实规格文件都出现在总索引中。 | `docs/coding-plugins/features/artifact-index/technical/technical-design.md` 中的影响组件追踪 | TD-003 | `python3 -m unittest scripts/test_preflight.py` | 单元测试 `test_artifact_index_requires_spec_paths`。 | `docs/coding-plugins/features/artifact-index/evidence/tdd-evidence.md` |
| REQ-004 | preflight 必须校验所有计划文件都出现在总索引中。 | `docs/coding-plugins/features/artifact-index/technical/technical-design.md` 中的影响组件追踪 | TD-004 | `python3 -m unittest scripts/test_preflight.py` | 单元测试 `test_artifact_index_requires_plan_paths`。 | `docs/coding-plugins/features/artifact-index/evidence/tdd-evidence.md` |
| REQ-005 | preflight 必须校验所有 TDD 证据 文件都出现在总索引中。 | `docs/coding-plugins/features/artifact-index/technical/technical-design.md` 中的影响组件追踪 | TD-005 | `python3 -m unittest scripts/test_preflight.py` | 单元测试 `test_artifact_index_requires_evidence_paths`。 | `docs/coding-plugins/features/artifact-index/evidence/tdd-evidence.md` |
