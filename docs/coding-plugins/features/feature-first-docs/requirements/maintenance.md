...
| NFR-003 | 必须 | 技术设计必须保存到 `docs/coding-plugins/features/{feature}/technicals/technical-design.md`。 | 单元测试 `test_collect_technical_design_files_uses_feature_first_technical_subdir`。 |
