...
| 状态 | 已批准 |
| Feature | technical-design-validator |
| 需求文档 | `docs/coding-plugins/features/technical-design-validator/requirements/feature.md` |
| 计划 | `docs/coding-plugins/features/technical-design-validator/plans/implementation.md` |
...
| `docs/coding-plugins/features/*/technicals/technical-design.md` | 迁移历史 technical 映射表、关键决策、lifecycle metadata 和设计约束标记 | REQ-007, REQ-008, REQ-009, REQ-010, AC-005 |
