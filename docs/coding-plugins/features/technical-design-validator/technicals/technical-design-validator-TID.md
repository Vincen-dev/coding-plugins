---
title: technical-design-validator 技术实现
status: approved
...
---
# technical-design-validator 技术实现
...
| 生命周期 | implemented |
| Feature | technical-design-validator |
| Doc ID | technical-design-validator |
...
| 模块 / 文件 | 实现说明 | 关联设计 |
| --- | --- | --- |
| `docs/coding-plugins/features/technical-design-validator/technicals/technical-design-validator-TDD.md` | 设计决策、影响组件和测试策略的来源。 | TDD |
| `docs/coding-plugins/features/technical-design-validator/plans/technical-design-validator-IPD.md` | 历史执行任务和落地步骤的来源。 | IPD |
