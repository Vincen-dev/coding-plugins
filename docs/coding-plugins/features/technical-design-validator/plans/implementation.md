...
| 技术设计 | `docs/coding-plugins/features/technical-design-validator/technicals/technical-design.md` |
...
**规格来源:** `docs/coding-plugins/features/technical-design-validator/requirements/feature.md`

**技术设计来源:** `docs/coding-plugins/features/technical-design-validator/technicals/technical-design.md`
...
| --- | --- | --- | --- | --- |
| REQ-001 | `python3 -m unittest skills/writing-technical-design/scripts/test_validate_technical_design.py` | `test_cli_validates_repository_technical_docs` | `docs/coding-plugins/features/technical-design-validator/evidence/tdd-evidence.md` / Task 1 | Task 1 |
...
- 修改: `docs/coding-plugins/features/technical-design-validator/evidence/tdd-evidence.md`
...
Write RED/GREEN/REFACTOR evidence into `docs/coding-plugins/features/technical-design-validator/evidence/tdd-evidence.md`.
