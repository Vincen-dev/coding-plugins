...
| 编号 | 场景 | 前置条件 | 操作 | 期望结果 |
| --- | --- | --- | --- | --- |
| AC-001 | 独立校验 technical | 仓库存在 feature-first technical 文档 | 运行 `python3 skills/writing-technical-design/scripts/validate_technical_design.py docs/coding-plugins/features/spec-technical-quality-gates/technicals/technical-design.md` | 命令返回 0，并输出校验通过或 warning 摘要。 |
...
| AC-001 | 命令验证 | `python3 skills/writing-technical-design/scripts/validate_technical_design.py docs/coding-plugins/features/spec-technical-quality-gates/technicals/technical-design.md` | Task 4 | 已覆盖 |
