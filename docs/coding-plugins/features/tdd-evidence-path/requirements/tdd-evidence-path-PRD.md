...
| REQ-005 | 必须 | preflight 必须自动严格校验 `docs/coding-plugins/features/**/evidences/**/*.md` 下的证据文件。 | 单测 `test_collect_tdd_evidence_files_uses_feature_first_path` 和 preflight 命令。 |
