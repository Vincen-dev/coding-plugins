...
- **Alternative verification:** `python3 scripts/preflight.py --write-index`、`python3 scripts/preflight.py`、`codex plugin add coding-plugins@personal`、`claude plugin validate /Users/vincen/workspace/plugins/coding-plugins --strict`。
