...
- **最终验证:** `python3 skills/writing-technical-design/scripts/validate_technical_design.py docs/coding-plugins/features/plugin/spec-technical-quality-gates/technical/technical-design.md`，Technical design validation passed: 1 file(s)。
...
- **GREEN 命令:** `python3 skills/spec-driven-development/scripts/validate_spec.py --strict docs/coding-plugins/features/plugin/technical-design-validator/specs/feature.md`，Spec validation passed。
