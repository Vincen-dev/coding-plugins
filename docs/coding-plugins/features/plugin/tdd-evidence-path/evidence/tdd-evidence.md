...
- **RED test:** `scripts/test_preflight.py::PreflightTests.test_collect_tdd_evidence_files_uses_feature_first_path` 和 `scripts/test_preflight.py::PreflightTests.test_build_commands_include_core_validation_steps`
...
- **Final verification:** `python3 scripts/preflight.py` PASS，包含 `validate_tdd_evidence.py --strict docs/coding-plugins/features/plugin/tdd-evidence-path/evidence/tdd-evidence.md`
