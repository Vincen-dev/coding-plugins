...
**规格来源:** `docs/coding-plugins/features/plugin/artifact-index/specs/feature.md`

**技术设计来源:** `docs/coding-plugins/features/plugin/artifact-index/technical/technical-design.md`
...
| --- | --- | --- | --- | --- |
| REQ-001 | `python3 scripts/preflight.py` | existing artifact index exists | `docs/coding-plugins/features/plugin/artifact-index/evidence/tdd-evidence.md` / 最终验证 | Task 3 |
...
| AC-003 | `python3 scripts/preflight.py --write-index` | rewrites `docs/coding-plugins/INDEX.md` before checks | `docs/coding-plugins/features/plugin/artifact-index/evidence/tdd-evidence.md` / 最终验证 | Task 3 |
...
- 修改: `docs/coding-plugins/features/plugin/artifact-index/README.md`
- 修改: `docs/coding-plugins/features/plugin/artifact-index/specs/feature.md`
- 创建: `docs/coding-plugins/features/plugin/artifact-index/technical/technical-design.md`
- 创建: `docs/coding-plugins/features/plugin/artifact-index/plans/implementation.md`
- 修改: `docs/coding-plugins/features/plugin/artifact-index/evidence/tdd-evidence.md`
