...
- **RED test:** `scripts/test_preflight.py::PreflightTests.test_collect_plan_files_uses_feature_first_path`、`scripts/test_preflight.py::PreflightTests.test_artifact_index_requires_index_file`、`scripts/test_preflight.py::PreflightTests.test_artifact_index_requires_expected_headers`、`scripts/test_preflight.py::PreflightTests.test_artifact_index_requires_spec_paths`、`scripts/test_preflight.py::PreflightTests.test_artifact_index_requires_plan_paths` 和 `scripts/test_preflight.py::PreflightTests.test_artifact_index_requires_evidence_paths`
