...
| --- | --- | --- | --- | --- |
| REQ-001 | 单元测试、仓库校验 | `python3 -m unittest scripts/test_preflight.py`、`python3 scripts/preflight.py` | 任务 1、任务 2、任务 3 | 计划中 |
| REQ-002 | 单元测试 | `python3 -m unittest skills/test-driven-development/scripts/test_validate_tdd_evidence.py` | 任务 1 | 计划中 |
| REQ-003 | 单元测试 | `python3 -m unittest skills/writing-technical-design/scripts/test_validate_technical_design.py` | 任务 1 | 计划中 |
| REQ-004 | 单元测试 | `python3 -m unittest scripts/test_preflight.py`、`python3 -m unittest scripts/test_docs_index.py` | 任务 1、任务 2 | 计划中 |
| REQ-005 | 仓库校验 | `python3 scripts/preflight.py --write-index`、`python3 scripts/preflight.py` | 任务 3 | 计划中 |
| REQ-006 | 单元测试、仓库校验 | `python3 -m unittest scripts/test_preflight.py`、`python3 scripts/preflight.py` | 任务 1、任务 3 | 计划中 |
| ERR-001 | 单元测试 | `python3 -m unittest scripts/test_preflight.py` | 任务 1 | 计划中 |
| ERR-002 | 单元测试 | `python3 -m unittest skills/test-driven-development/scripts/test_validate_tdd_evidence.py` | 任务 1 | 计划中 |
| ERR-003 | 单元测试 | `python3 -m unittest skills/writing-technical-design/scripts/test_validate_technical_design.py` | 任务 1 | 计划中 |
| ERR-004 | 单元测试 | `python3 -m unittest scripts/test_preflight.py` | 任务 1、任务 2 | 计划中 |
| AC-001 | 人工审查、仓库校验 | `skills/test-driven-development/templates/tdd-evidence.md`、`python3 scripts/preflight.py` | 任务 2 | 计划中 |
| AC-002 | 单元测试 | `python3 -m unittest skills/writing-technical-design/scripts/test_validate_technical_design.py` | 任务 1、任务 2 | 计划中 |
| AC-003 | 人工审查、仓库校验 | `skills/writing-plans/SKILL.md`、`python3 scripts/preflight.py` | 任务 2 | 计划中 |
| AC-004 | 仓库校验 | `python3 scripts/preflight.py` | 任务 4 | 计划中 |
