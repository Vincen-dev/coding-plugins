...
**规格来源:** `docs/coding-plugins/features/plugin/release-management/specs/feature.md`

**技术设计来源:** `docs/coding-plugins/features/plugin/release-management/technical/technical-design.md`
...
**TDD 证据目标:** `docs/coding-plugins/features/plugin/release-management/evidence/tdd-evidence.md`
...
- 修改: `docs/coding-plugins/features/plugin/release-management/evidence/tdd-evidence.md`
...
- 修改: `docs/coding-plugins/features/plugin/release-management/specs/feature.md`
- 修改: `docs/coding-plugins/features/plugin/release-management/technical/technical-design.md`
- 修改: `docs/coding-plugins/features/plugin/release-management/plans/implementation.md`
- 修改: `docs/coding-plugins/features/plugin/release-management/evidence/tdd-evidence.md`
