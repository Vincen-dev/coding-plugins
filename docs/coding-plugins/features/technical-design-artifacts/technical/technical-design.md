...
| 决策 ID | 决策 | 原因 | 取舍 |
| --- | --- | --- | --- |
| TD-001 | 在 feature root 的 `technical/` 子目录下新增 `technical/technical-design.md`，而不是复用 `plans/implementation.md` | 区分稳定技术方案和执行任务，避免 `plans/implementation.md` 同时承担设计和步骤 | 需要维护新的引用和校验规则 |
...
- Technical design path: `docs/coding-plugins/features/technical-design-artifacts/technical/technical-design.md`
