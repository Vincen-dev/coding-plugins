...
| 实现计划 | `docs/coding-plugins/features/preflight/plans/preflight-IPD.md` |
...
| 模块 / 文件 | 实现说明 | 关联设计 |
| --- | --- | --- |
| `docs/coding-plugins/features/preflight/technicals/preflight-TDD.md` | 设计决策、影响组件和测试策略的来源。 | TDD |
| `docs/coding-plugins/features/preflight/plans/preflight-IPD.md` | 历史执行任务和落地步骤的来源。 | IPD |
