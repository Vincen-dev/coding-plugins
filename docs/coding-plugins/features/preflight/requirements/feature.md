...
| REQ-002 | 规格校验 | `python3 skills/spec-driven-development/scripts/validate_spec.py --strict docs/coding-plugins/features/preflight/requirements/feature.md` | Task 1 | 已覆盖 |
