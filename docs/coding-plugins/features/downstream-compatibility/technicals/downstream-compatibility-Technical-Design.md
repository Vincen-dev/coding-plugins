...
related_plans:
  - docs/coding-plugins/features/downstream-compatibility/plans/downstream-compatibility-Implementation-Plan.md
related_evidence:
...
| 计划 | `docs/coding-plugins/features/downstream-compatibility/plans/downstream-compatibility-Implementation-Plan.md` |
...
- 设计约束：active evidence 只使用 `evidences/<feature-name>-TDD-Evidence.md`；archive 位于 `evidences/archive/*.md`。
...
- Evidence: `docs/coding-plugins/features/downstream-compatibility/evidences/downstream-compatibility-TDD-Evidence.md`
