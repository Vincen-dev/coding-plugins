---
title: downstream-compatibility 技术实现
status: approved
...
| 生命周期 | implemented |
| Feature | downstream-compatibility |
| Doc ID | downstream-compatibility |
...
| 实现计划 | `docs/coding-plugins/features/downstream-compatibility/plans/downstream-compatibility-IPD.md` |
...
| 模块 / 文件 | 实现说明 | 关联设计 |
| --- | --- | --- |
| `docs/coding-plugins/features/downstream-compatibility/technicals/downstream-compatibility-TDD.md` | 设计决策、影响组件和测试策略的来源。 | TDD |
| `docs/coding-plugins/features/downstream-compatibility/plans/downstream-compatibility-IPD.md` | 历史执行任务和落地步骤的来源。 | IPD |
