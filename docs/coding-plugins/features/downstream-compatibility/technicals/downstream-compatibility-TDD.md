...
| 计划 | `docs/coding-plugins/features/downstream-compatibility/plans/downstream-compatibility-IPD.md` |
...
- 设计约束：active evidence 只使用 `evidences/<feature-name>-TED.md`；archive 位于 `evidences/archive/*.md`。
...
- Evidence: `docs/coding-plugins/features/downstream-compatibility/evidences/downstream-compatibility-TED.md`
