---
title: spec-technical-quality-gates 技术实现
status: approved
...
---
# spec-technical-quality-gates 技术实现
...
| 生命周期 | implemented |
| Feature | spec-technical-quality-gates |
| Doc ID | spec-technical-quality-gates |
...
| 模块 / 文件 | 实现说明 | 关联设计 |
| --- | --- | --- |
| `docs/coding-plugins/features/spec-technical-quality-gates/technicals/spec-technical-quality-gates-TDD.md` | 设计决策、影响组件和测试策略的来源。 | TDD |
| `docs/coding-plugins/features/spec-technical-quality-gates/plans/spec-technical-quality-gates-IPD.md` | 历史执行任务和落地步骤的来源。 | IPD |
