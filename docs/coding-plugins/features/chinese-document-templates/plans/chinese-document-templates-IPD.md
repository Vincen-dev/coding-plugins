...
| `skills/writing-technicals/scripts/validate_technicals.py` | technical 映射表头改中文 | REQ-003 |
...
**TDD 证据目标:** `docs/coding-plugins/features/chinese-document-templates/evidences/chinese-document-templates-TED.md`
...
| --- | --- | --- | --- | --- |
| REQ-001 | `python3 -m unittest scripts/test_preflight.py` | plan 和 TDD 模板英文展示字段失败 | `docs/coding-plugins/features/chinese-document-templates/evidences/chinese-document-templates-TED.md` / TDD 证据 | 任务 1、任务 2 |
| REQ-002 | `python3 -m unittest skills/test-driven-development/scripts/test_validate_tdd_evidence.py` | 中文 TDD evidence 通过，英文展示字段失败 | `docs/coding-plugins/features/chinese-document-templates/evidences/chinese-document-templates-TED.md` / TDD 证据 | 任务 1 |
| REQ-003 | `python3 -m unittest skills/writing-technicals/scripts/test_validate_technicals.py` | 中文 technical 映射表通过 | `docs/coding-plugins/features/chinese-document-templates/evidences/chinese-document-templates-TED.md` / TDD 证据 | 任务 1 |
| REQ-004 | `python3 -m unittest scripts/test_docs_index.py scripts/test_preflight.py` | docs index 和轻量例外表头中文 | `docs/coding-plugins/features/chinese-document-templates/evidences/chinese-document-templates-TED.md` / TDD 证据 | 任务 1、任务 3 |
| REQ-005 | `python3 scripts/preflight.py --write-index`、`python3 scripts/preflight.py` | 既有文档迁移后全量门禁通过 | `docs/coding-plugins/features/chinese-document-templates/evidences/chinese-document-templates-TED.md` / TDD 证据 | 任务 3、任务 4 |
| REQ-006 | `python3 scripts/preflight.py` | metadata key 和工程标识不触发中文化失败 | `docs/coding-plugins/features/chinese-document-templates/evidences/chinese-document-templates-TED.md` / TDD 证据 | 任务 1、任务 4 |
...
python3 -m unittest skills/writing-technicals/scripts/test_validate_technicals.py
...
更新 `docs/coding-plugins/features/chinese-document-templates/evidences/chinese-document-templates-TED.md` 的任务 1。
...
- 修改: `docs/coding-plugins/features/**/plans/**-IPD.md`
- 修改: `docs/coding-plugins/features/**/evidences/**-TED.md`
...
**文件:**
- 修改: `docs/coding-plugins/features/chinese-document-templates/evidences/chinese-document-templates-TED.md`
