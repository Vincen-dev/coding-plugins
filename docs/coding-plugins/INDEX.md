...
本索引用于按 `Area` 和 `Capability` 检索规格、技术设计、计划和 TDD Evidence。新增、移动、批准、废弃或拆分相关产物时同步更新本文件。
...
| plugin | technical-design-artifacts | `docs/coding-plugins/specs/plugin/technical-design-artifacts/feature.md` | `docs/coding-plugins/technical/plugin/technical-design-artifacts/technical-design.md` | `docs/coding-plugins/plans/plugin/technical-design-artifacts/implementation.md` | `docs/coding-plugins/evidence/plugin/technical-design-artifacts/tdd-evidence.md` | technical-design, architecture, traceability, workflow | 2026-06-26 |
...
- `Technical` 指向默认技术设计 `docs/coding-plugins/technical/<area>/<capability>/technical-design.md`；没有技术设计时使用 `-`。
