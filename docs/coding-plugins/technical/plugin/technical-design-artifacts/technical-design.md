...
related_plans:
  - docs/coding-plugins/plans/plugin/technical-design-artifacts/implementation.md
---
...
| --- | --- | --- |
| 新增 `technical` 目录，而不是复用 `plans` | 区分稳定技术方案和执行任务，避免 `implementation.md` 同时承担设计和步骤 | 需要维护一个新的索引和校验规则 |
...
| 总索引增加 `Technical` 列 | 检索 capability 时能看到 Spec、Technical、Plan、Evidence 全链路 | 需要更新既有索引行 |
...
| `docs/coding-plugins/technical/INDEX.md` | 新增 technical 专用索引 | REQ-002 |
| `docs/coding-plugins/INDEX.md` | 新增 `Technical` 列 | REQ-003 |
...
flowchart TD
  ...
  F --> G["tdd-evidence.md"]
  C --> H["technical/INDEX.md"]
  C --> I["docs/coding-plugins/INDEX.md"]
```

## Interfaces and Contracts

- Technical design path: `docs/coding-plugins/technical/plugin/technical-design-artifacts/technical-design.md`
- Plan path: `docs/coding-plugins/plans/plugin/technical-design-artifacts/implementation.md`
- Evidence path: `docs/coding-plugins/evidence/plugin/technical-design-artifacts/tdd-evidence.md`
...
- TDD Evidence 写入 `docs/coding-plugins/evidence/plugin/technical-design-artifacts/tdd-evidence.md`。
