...
import { auditState, checkState, initState, transitionState } from "../../lib/workflow/project-state.ts";
...
function parseArgs(argv: string[]): Options {
  ...
  const options: Options = { command, root: ".", json: false, to: command === "transition" ? maybeTo : undefined };
