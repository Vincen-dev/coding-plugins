...
import { approveGovernedDecision, auditFormalCompletion } from "../../lib/workflow/governed-orchestrator.ts";

type TaskCliAction = TaskAction | "approve" | "complete";
...
try {
  ...
  if (options.action === "approve") {
    ...
    const payload = buildTaskStatus({
      ...options,
      action: options.action as TaskAction,
