...
import { checkCommitGuard } from "../lib/git/commit-guard.ts";
import type { CommitLanguage } from "../lib/git/commit-guard.ts";
...
function withGitDefaults(options: Options): Options {
...
function printText(result: ReturnType<typeof checkCommitGuard>): void {
