...
export const COMMAND_REGISTRY = [
  ...
  { name: "cli", script: "src/cli/cli.ts", usage: "cli <status|install|uninstall> [--scope user|project] [--target <path>] [--root <path>] [--thread-id <id>] [--format text|json] [--force]" },
  ...
  { name: "doctor", script: "src/cli/doctor.ts", usage: "doctor [--root <path>] [--require-env <checks>] [--format text|json]" },
  ...
  { name: "preflight", script: "src/cli/preflight.ts", usage: "preflight [--root <path>] [--write-index] [--check-external-references]" },
  ...
  { name: "report", script: "src/cli/report.ts", usage: "report completion [--kind task|release] [--implemented <items>] [--verified <command=status>] [--commit-pushed] [--dependency-resolved] [--json]" },
  ...
  { name: "task", script: "src/cli/task.ts", usage: "task <start|continue|status|brief|approve|complete> [--intent <text>] [--feature <name>] [--doc-id <id>] [--id DP-1|DP-2|DP-3] [--reason <text>] [--change-id <id>] [--contract-version 1|2] [--planned-file <path>] [--task-count <n>] [--feature-count <n>] [--root <path>] [--json]" },
