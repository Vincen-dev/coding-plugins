...
import { artifactPath } from "./workflow-state.ts";
...
export function extractTaskPolicyContext(text: string, taskId: string): { policyIds: string[]; skills: string[] } {
