...
| --- | --- | --- | --- | --- | --- | --- |
| REQ-001 | 登录路由根据会话状态选择页面 | `src/cli/preflight.ts` 链路校验 | TD-001 | `check_feature_document_chain_closure` | `npm run preflight` | `docs/coding-plugins/features/routing-fixture/evidences/routing-login-VED.md` |
