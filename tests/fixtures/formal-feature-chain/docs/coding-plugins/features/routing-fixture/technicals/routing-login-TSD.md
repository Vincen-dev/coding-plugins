...
- 方案 A：使用现有正式链路 fixture 结构维护 登录路由按会话状态分流。
...
| --- | --- | --- | --- | --- | --- | --- |
| REQ-001 | 登录路由根据会话状态选择页面 | `src/cli/preflight.ts` 链路校验 | TD-001 | `check_feature_document_chain_closure` | `npm run preflight` | 同一 `doc_id` 的 VED |
