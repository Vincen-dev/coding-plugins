  ...
  try {
    const evidence = writeEvidence(
      ...
      "---\n" +
        ...
        "related_technical:\n" +
        "  - docs/coding-plugins/features/demo-app/technicals/demo-app-TSD.md\n" +
        "---\n" +
        "# Evidence\n",
    );
    ...
    assert.ok(migrated.includes("docs/coding-plugins/features/demo-app/technicals/demo-app-TSD.md"));
