...
docs/coding-plugins/features/auth-login/plans/auth-login-IPD.md
docs/coding-plugins/features/auth-login/evidences/auth-login-TED.md
```
...
```bash
python3 skills/test-driven-development/scripts/validate_tdd_evidence.py docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TED.md
```
