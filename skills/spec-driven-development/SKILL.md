...
8. **编写技术方案**：需求确认后调用 `writing-technical-design`，输出 `technicals/technical-design.md`。
...
| 技术方案设计 | `writing-technical-design` | `docs/coding-plugins/features/<feature-name>/technicals/technical-design.md` | 架构、关键决策、技术落点 |
