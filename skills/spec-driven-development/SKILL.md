...
11. **维护索引和关系**：新增、移动、批准、废弃或拆分文档时，运行 `npm run preflight -- --write-index` 生成 `docs/coding-plugins/INDEX.md`；新增下游 TDD/TID/TCD/IPD/TED 后必须回填 PRD 的 `related_*` metadata。
...
5. 如果需求横跨多个独立 feature，拆分 feature root，并用 `related_specs` 互链。
