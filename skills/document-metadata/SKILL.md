...
| PRD | `spec_id`、`title`、`type`、`status`、`feature`、`created`、`updated`、`tags` | 必须在对应下游文档存在时链接 `related_technical`、`related_test_cases`、`related_plans`、`related_evidence`，并可链接 `related_specs`、`related_code` |
