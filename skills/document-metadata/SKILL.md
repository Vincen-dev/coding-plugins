...
文档 metadata 是 Coding Plugins 文档系统的机器可读入口。读取或维护 `docs/coding-plugins/features/<feature-name>/` 下的 README、PRD、TDD、TID、TCD、IPD、TED 时，先读 frontmatter，再读正文。同一 feature 模块下可以有多条文档链路，链路由 `doc_id` 区分。
