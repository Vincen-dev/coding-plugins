...
默认保存到：`docs/coding-plugins/features/<feature-name>/plans/<feature-name>-IPD.md`。用户偏好的路径优先。

对应 TDD 证据默认保存到：`docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TED.md`。
...
- 计划路径的 `<feature-name>` 应和规格路径保持一致，例如 `features/auth-login/requirements/auth-login-PRD.md` 对应 `features/auth-login/plans/auth-login-IPD.md`。
- TDD 证据路径的 `<feature-name>` 也应保持一致，例如 `features/auth-login/plans/auth-login-IPD.md` 对应 `features/auth-login/evidences/auth-login-TED.md`。
...
- **技术设计来源**：真实存在的 `technicals/<feature-name>-TDD.md` 路径。
- **技术实现来源**：真实存在的 `technicals/<feature-name>-TID.md` 路径；如果不存在 TID，写明“不适用：<原因>”。
...
related_technical:
  - docs/coding-plugins/features/[feature]/technicals/[feature]-TDD.md
  - docs/coding-plugins/features/[feature]/technicals/[feature]-TID.md
related_test_cases:
  - docs/coding-plugins/features/[feature]/test-cases/[feature]-TCD.md
related_evidence:
  - docs/coding-plugins/features/[feature]/evidences/[feature]-TED.md
---
...
| 技术设计 | `docs/coding-plugins/features/[feature]/technicals/[feature]-TDD.md` |
| 技术实现 | `docs/coding-plugins/features/[feature]/technicals/[feature]-TID.md` |
| 测试用例 | `docs/coding-plugins/features/[feature]/test-cases/[feature]-TCD.md` |
| TDD 证据| `docs/coding-plugins/features/[feature]/evidences/[feature]-TED.md` |
...
**TDD 证据目标:** `docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TED.md`
...
| --- | --- | --- | --- | --- |
| REQ-001 | `tests/path/test_file.py` | `test_specific_behavior` | `docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TED.md` / RED-GREEN-最终验证 | 任务 1 |
...
写入或更新 `docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TED.md`。生成真实计划时，把每个方括号占位内容替换成该任务的具体预期证据：
...
```bash
python3 skills/test-driven-development/scripts/validate_tdd_evidence.py --strict docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TED.md
```
...
> 计划已完成并保存到 `docs/coding-plugins/features/<feature-name>/plans/<feature-name>-IPD.md`。有两种执行方式：
>
