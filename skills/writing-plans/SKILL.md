...
默认保存到：`docs/coding-plugins/features/<feature-name>/plans/<feature-name>-Implementation-Plan.md`。用户偏好的路径优先。

对应 TDD 证据默认保存到：`docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TDD-Evidence.md`。
...
- 计划路径的 `<feature-name>` 应和规格路径保持一致，例如 `features/auth-login/requirements/auth-login-PRD.md` 对应 `features/auth-login/plans/auth-login-Implementation-Plan.md`。
- TDD 证据路径的 `<feature-name>` 也应保持一致，例如 `features/auth-login/plans/auth-login-Implementation-Plan.md` 对应 `features/auth-login/evidences/auth-login-TDD-Evidence.md`。
...
完整技术设计写在 `docs/coding-plugins/features/<feature-name>/technicals/<feature-name>-Technical-Design.md`，计划必须引用它。计划中的技术方案只保留执行所需快照，重点是把设计拆成可测试任务。

必须覆盖：

- **技术设计来源**：真实存在的 `technicals/<feature-name>-Technical-Design.md` 路径。
...
updated: YYYY-MM-DD
related_specs:
  - docs/coding-plugins/features/[feature]/requirements/[feature]-PRD.md
related_technical:
  - docs/coding-plugins/features/[feature]/technicals/[feature]-Technical-Design.md
related_test_cases:
  - docs/coding-plugins/features/[feature]/test-cases/[feature]-Test-Cases.md
related_evidence:
  - docs/coding-plugins/features/[feature]/evidences/[feature]-TDD-Evidence.md
---
...
| 状态 | 草稿 |
| Feature | [feature] |
| 需求文档 | `docs/coding-plugins/features/[feature]/requirements/[feature]-PRD.md` |
| 技术设计 | `docs/coding-plugins/features/[feature]/technicals/[feature]-Technical-Design.md` |
| 测试用例 | `docs/coding-plugins/features/[feature]/test-cases/[feature]-Test-Cases.md` |
| TDD 证据| `docs/coding-plugins/features/[feature]/evidences/[feature]-TDD-Evidence.md` |
...
**TDD 证据目标:** `docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TDD-Evidence.md`
...
| --- | --- | --- | --- | --- |
| REQ-001 | `tests/path/test_file.py` | `test_specific_behavior` | `docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TDD-Evidence.md` / RED-GREEN-最终验证 | 任务 1 |
...
写入或更新 `docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TDD-Evidence.md`。生成真实计划时，把每个方括号占位内容替换成该任务的具体预期证据：
...
```bash
python3 skills/test-driven-development/scripts/validate_tdd_evidence.py --strict docs/coding-plugins/features/<feature-name>/evidences/<feature-name>-TDD-Evidence.md
```
...
> 计划已完成并保存到 `docs/coding-plugins/features/<feature-name>/plans/<feature-name>-Implementation-Plan.md`。有两种执行方式：
>
