...
import validate_technicals as validator


SCRIPT_PATH = Path(__file__).resolve().with_name("validate_technicals.py")
...
class TechnicalDesignValidatorTests(unittest.TestCase):
    def write_feature(
        ...
        *,
        ...
        (evidence_dir / f"{evidence_dir.parent.name}-TED.md").write_text("# Evidence\n", encoding="utf-8")
        ...
        technical = technicals_dir / f"{technicals_dir.parent.name}-TDD.md"
