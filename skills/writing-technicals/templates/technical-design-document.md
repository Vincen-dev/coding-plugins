...
<2 到 5 句话说明整体技术方案。必须写出核心设计、边界、不做什么、主要风险或验证方式。>
...
| --- | --- | --- | --- | --- | --- | --- |
| REQ-001 | <规格摘要> | `<path>::<symbol>` 或 <具体模块落点；不得写“见下文”> | TD-001 | `<path>` | <测试命令或测试名称> | `docs/coding-plugins/features/<feature-name>/evidences/<doc-id>-TED.md` |
