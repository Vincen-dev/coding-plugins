...
- **技术实现文档**：当设计会改动代码、schema、接口、状态机或数据迁移时，必须创建或更新 `<doc-id>-TID.md`；纯文档或极轻量变更可在 TDD 中写明“不需要 TID”。
...
6. 如需要代码、schema、接口、状态机或迁移落地，创建或更新 `technicals/<doc-id>-TID.md`，并在 TDD 的实现落地章节引用它。
