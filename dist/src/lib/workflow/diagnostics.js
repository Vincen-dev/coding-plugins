...
export function createWorkflowDiagnostic(code) {
...
export function sortWorkflowDiagnostics(diagnostics) {
    return [...diagnostics].sort((left, right) => {
        const leftPriority = left.code in WORKFLOW_DIAGNOSTIC_CODES
            ? WORKFLOW_DIAGNOSTIC_CODES[left.code].priority
            : Number.MAX_SAFE_INTEGER;
        const rightPriority = right.code in WORKFLOW_DIAGNOSTIC_CODES
            ? WORKFLOW_DIAGNOSTIC_CODES[right.code].priority
            : Number.MAX_SAFE_INTEGER;
