...
import { parseFrontmatterBlock, RELATED_DOCS_KEY, renderFrontmatterBlock, splitFrontmatter } from "./document-metadata.js";
...
export function featureContext(path) {
...
export function migrateBodyStatusAliases(body) {
    let migrated = body;
...
export function migrateFile(path, options = {}) {
