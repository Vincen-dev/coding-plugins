...
import { buildExecutionContract, writeExecutionContract } from "../../lib/workflow/execution-contract.js";
...
function parseArgs(argv) {
    ...
    const options = { command, root: ".", format: "text", write: false };
    for (let index = 0; index < rest.length; index += 1) {
        ...
        if (arg === "--root") {
            ...
            options.format = requireValue(rest, index, arg);
            index += 1;
        }
        else if (arg === "--write") {
            options.write = true;
