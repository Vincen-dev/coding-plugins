#!/usr/bin/env node
import { resolveRoot, runAll, writeHarnessOutput } from "../../lib/agents/agent-pressure-harness.js";
...
try {
    ...
    process.exit(payload.cases.every((caseData) => caseData.scenario_passed) ? 0 : 1);
}
catch (error) {
