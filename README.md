...
Coding Plugins 是 Superpowers 风格的中文编码代理方法论插件。它由一组可组合的 skills、提示词模板、参考资料和脚本组成，用来约束编码代理在做软件开发时先澄清、再计划、再小步实现、再验证和收尾。
...
9. **git-commit** - 用户要求提交或完成阶段需要提交时，生成中文 Conventional Commit，在 footer 添加本人作者署名，并禁止 AI 作者或 AI 生成声明。
...
- `git-commit`：中文 Conventional Commit，检查作者身份，在 footer 添加本人作者署名，禁止 AI 作者。
